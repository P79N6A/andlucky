...
class ClientTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testAccountAttributes()
    {
        try {
            ...
            $this->assertEquals("Test", $res->getAccountAttributes()
                ->getLoggingBucket());
            ...
            $res = $this->client->getAccountAttributes();
            $this->assertTrue($res->isSucceed());
            $this->assertEquals("", $res->getAccountAttributes()
                ->getLoggingBucket());
    ...
    public function testCreateQueueAsync()
    {
        ...
        try {
            $res = $this->client->createQueueAsync($request, new AsyncCallback(function ($response) {
    ...
    public function testListQueueAsync()
    {
        ...
        while ($count < 2) {
            try {
                $res = $this->client->listQueueAsync($request, new AsyncCallback(function ($response) use ($count, &$request, $queueName1, $queueName2, &$queueName1Found, &$queueName2Found) {
                    $this->assertTrue($response->isSucceed());
