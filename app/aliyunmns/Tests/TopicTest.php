...
class TopicTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testLoggingEnabled()
    {
        ...
        try {
            ...
            $this->assertTrue($res->isSucceed());
            $this->assertEquals(false, $res->getTopicAttributes()
                ->getLoggingEnabled());
            ...
            $res = $topic->getAttribute();
            $this->assertTrue($res->isSucceed());
            $this->assertEquals(true, $res->getTopicAttributes()
                ->getLoggingEnabled());
    ...
    public function testTopicAttributes()
    {
        ...
        try {
            $res = $topic->getAttribute();
            $this->assertTrue($res->isSucceed());
            $this->assertEquals($topicName, $res->getTopicAttributes()
                ->getTopicName());
        } catch (MnsException $e) {
            $this->assertTrue(FALSE, $e);
        }
        ...
        try {
            $res = $topic->getAttribute();
            $this->assertTrue($res->isSucceed());
            $this->assertEquals($res->getTopicAttributes()
                ->getMaximumMessageSize(), $maximumMessageSize);
        } catch (MnsException $e) {
            $this->assertTrue(FALSE, $e);
        }
    ...
    public function testPublishBatchSmsMessage()
    {
        ...
        try {
            ...
            $batchSmsAttributes->addReceiver("13735576932", array(
                "name" => "phpsdk-batchsms"
            ));
    ...
    public function testSubscriptionAttributes()
    {
        ...
        try {
            ...
            $this->assertTrue($res->isSucceed());
            $this->assertEquals($topicName, $res->getSubscriptionAttributes()
                ->getTopicName());
            $this->assertEquals('BACKOFF_RETRY', $res->getSubscriptionAttributes()
                ->getStrategy());
        } catch (MnsException $e) {
            $this->assertTrue(FALSE, $e);
        }
        ...
        try {
            $res = $topic->getSubscriptionAttribute($subscriptionName);
            $this->assertTrue($res->isSucceed());
            $this->assertEquals($res->getSubscriptionAttributes()
