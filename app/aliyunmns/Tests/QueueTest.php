...
class QueueTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testLoggingEnabled()
    {
        ...
        try {
            ...
            $this->assertTrue($res->isSucceed());
            $this->assertEquals(false, $res->getQueueAttributes()
                ->getLoggingEnabled());
            ...
            $res = $queue->getAttribute();
            $this->assertTrue($res->isSucceed());
            $this->assertEquals(true, $res->getQueueAttributes()
                ->getLoggingEnabled());
    ...
    public function testQueueAttributes()
    {
        ...
        try {
            $res = $queue->getAttribute();
            $this->assertTrue($res->isSucceed());
            $this->assertEquals($queueName, $res->getQueueAttributes()
                ->getQueueName());
        } catch (MnsException $e) {
            $this->assertTrue(FALSE, $e);
        }
        ...
        try {
            $res = $queue->getAttribute();
            $this->assertTrue($res->isSucceed());
            $this->assertEquals($res->getQueueAttributes()
                ->getDelaySeconds(), $delaySeconds);
        } catch (MnsException $e) {
            $this->assertTrue(FALSE, $e);
        }
    }
