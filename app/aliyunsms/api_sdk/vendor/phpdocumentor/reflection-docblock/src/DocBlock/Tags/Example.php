...
final class Example extends BaseTag
{
     ...
     *            The new file path to use for the example.
     *            
     * @return $this
     */
     ...
     *
     * @param string $uri
     *            The new file URI to use as an example.
     *            
     * @return $this
     */
    public function setFileURI($uri)
    {
        ...
        $this->filePath = $this->isUriRelative($uri) ? rawurldecode(str_replace(array(
            '/',
            '\\'
        ), '%2F', $uri)) : $this->filePath = $uri;
