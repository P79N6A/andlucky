...
class CallCenterSpec extends ObjectBehavior
{
    ...
    function it_records_calls_made_through_makeCall_method(ObjectProphecy $objectProphecy, ArgumentsWildcard $wildcard)
    {
        ...
        $this->makeCall($objectProphecy, 'setValues', array(
            5,
            2,
            3
        ));
        ...
        $calls[0]->getArguments()->shouldReturn(array(
            5,
            2,
            3
        ));
    ...
    function it_executes_promise_of_method_prophecy_that_matches_signature_passed_to_makeCall($objectProphecy, MethodProphecy $method1, MethodProphecy $method2, MethodProphecy $method3, ArgumentsWildcard $arguments1, ArgumentsWildcard $arguments2, ArgumentsWildcard $arguments3, PromiseInterface $promise)
    {
        ...
        $arguments1->scoreArguments(array(
            'world',
            'everything'
        ))->willReturn(false);
        ...
        $arguments2->scoreArguments(array(
            'world',
            'everything'
        ))->willReturn(false);
        ...
        $arguments3->scoreArguments(array(
            'world',
            'everything'
        ))->willReturn(200);
        ...
        $promise->execute(array(
            'world',
            'everything'
        ), $objectProphecy->getWrappedObject(), $method3)
            ->willReturn(42);
        
        $this->makeCall($objectProphecy, 'getName', array(
            'world',
            'everything'
        ))->shouldReturn(42);
    ...
    function it_executes_promise_of_method_prophecy_that_matches_with_highest_score_to_makeCall($objectProphecy, MethodProphecy $method1, MethodProphecy $method2, MethodProphecy $method3, ArgumentsWildcard $arguments1, ArgumentsWildcard $arguments2, ArgumentsWildcard $arguments3, PromiseInterface $promise)
    {
        ...
        $promise->execute(array(
            'world',
            'everything'
        ), $objectProphecy->getWrappedObject(), $method2)
            ->willReturn('second');
    ...
    function it_throws_exception_if_call_does_not_match_any_of_defined_method_prophecies($objectProphecy, MethodProphecy $method, ArgumentsWildcard $arguments)
    {
        ...
        $arguments->scoreArguments(array(
            'world',
            'everything'
        ))->willReturn(false);
        ...
        $this->shouldThrow('Prophecy\Exception\Call\UnexpectedCallException')->duringMakeCall($objectProphecy, 'getName', array(
            'world',
            'everything'
        ));
    }
    ...
    function it_finds_recorded_calls_by_a_method_name_and_arguments_wildcard($objectProphecy, ArgumentsWildcard $wildcard)
    {
        ...
        $this->makeCall($objectProphecy, 'setName', array(
            42
        ));
