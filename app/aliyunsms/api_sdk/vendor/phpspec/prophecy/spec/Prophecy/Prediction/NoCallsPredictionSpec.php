...
class NoCallsPredictionSpec extends ObjectBehavior
{
    ...
    function it_throws_UnexpectedCallsException_if_calls_found(ObjectProphecy $object, MethodProphecy $method, Call $call, ArgumentsWildcard $arguments)
    {
        ...
        $call->getArguments()->willReturn(array(
            5,
            4,
            'three'
        ));
        ...
        $this->shouldThrow('Prophecy\Exception\Prediction\UnexpectedCallsException')->duringCheck(array(
            $call
        ), $object, $method);
    }
}
