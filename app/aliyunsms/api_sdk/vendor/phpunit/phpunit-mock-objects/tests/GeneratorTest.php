...
class Framework_MockObject_GeneratorTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $this->generator->getMock('StdClass', array(
            0
        ));
    }
    ...
    {
        $mock = $this->generator->getMock('StdClass', array(
            'testFunction'
        ));
    ...
    {
        $mock = $this->generator->getMockForAbstractClass('AbstractMockTestClass', array(), '', true, true, true, array(
            'nonexistentMethod'
        ));
    ...
    {
        $mock = $this->generator->getMockForTrait('AbstractTrait', array(), '', true, true, true, array(
            'nonexistentMethod'
        ));
    ...
    public function testGetMockForSingletonWithReflectionSuccess()
    {
        ...
        $mock = $this->generator->getMock('SingletonClass', array(
            'doSomething'
        ), array(), '', false);
