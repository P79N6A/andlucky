...
class Framework_MockObjectTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testMockClassDifferentForPartialMocks()
    {
        ...
        $mock2 = $this->getMock('PartialMockTestClass', array(
            'doSomething'
        ));
        $mock3 = $this->getMock('PartialMockTestClass', array(
            'doSomething'
        ));
        $mock4 = $this->getMock('PartialMockTestClass', array(
            'doAnotherThing'
        ));
        $mock5 = $this->getMock('PartialMockTestClass', array(
            'doAnotherThing'
        ));
