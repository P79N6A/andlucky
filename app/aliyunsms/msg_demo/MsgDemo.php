...
class MsgDemo
{
    ...
    {
        $this->tokenGetter = new TokenGetterForAlicom($accountId, $accessKeyId, $accessKeySecret);
    }
     ...
     *            消息类型: SmsReport | SmsUp
     * @param string $queueName
     *            在云通信页面开通相应业务消息后，就能在页面上获得对应的queueName<br/>(e.g. Alicom-Queue-xxxxxx-SmsReport)
...
$demo = new MsgDemo("1943695596114318", // 这个变量不需要修改!
