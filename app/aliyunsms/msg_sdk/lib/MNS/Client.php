...
class Client
{
     ...
     * @param
     *            accessId: accessId from aliyun.com
     * @param
     *            accessKey: accessKey from aliyun.com
     * @param
     *            securityToken: securityToken from aliyun.com
     * @param
     *            config: necessary configs
     */
     ...
     *            the queue name
     * @param bool $base64:
     *            whether the message in queue will be base64 encoded
     *            
     ...
     *            the QueueName and QueueAttributes
     *            
     ...
     *            the Callback when the request finishes
     *            
     ...
     *            define filters for quering queues
     *            
     ...
     *            the TopicName and TopicAttributes
     *            
     ...
     *            define filters for quering topics
     *            
