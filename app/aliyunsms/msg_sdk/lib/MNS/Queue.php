...
class Queue
{
     ...
     *
     * @param QueueAttributes $attributes:
     *            the QueueAttributes to set
     *            
     ...
     *
     * @param
     *            SendMessageRequest: containing the message body and properties
     *            
     ...
     *
     * @param
     *            waitSeconds: the long polling waitseconds
     *            
     ...
     * https://docs.aliyun.com/?spm=#/pub/mns/api_reference/api_spec&message_operation
     *
     * @param $receiptHandle: the
     *            receiptHandle returned from receiveMessage
     *            
     ...
     *            
     * @return BatchReceiveMessageResponse: the received messages
     *        
     * @throws QueueNotExistException if queue does not exist
     ...
     *            containing numOfMessages and waitSeconds
     *            
     * @return BatchPeekMessageResponse: the received messages
     *        
     * @throws QueueNotExistException if queue does not exist
     * @throws MessageNotExistException if no message exists
     * @throws MnsException if any other exception happends
     ...
     * https://docs.aliyun.com/?spm=#/pub/mns/api_reference/api_spec&message_operation
     *
     * @param $receiptHandles: array
     *            of $receiptHandle, which is got from receiveMessage
     *            
