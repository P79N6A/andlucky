...
class InlineTest extends TestCase
{
     ...
     * " ", ",", "[", "]", "{", "}") is deprecated since version 3.2 and will throw a ParseException in 4.0.
    ...
    public function getTestsForParseWithMapObjects()
    {
        return array(
            ...
            array(
                ...
                Yaml::PARSE_OBJECT_FOR_MAP | Yaml::PARSE_KEYS_AS_STRINGS
            ),
            array(
                '{ foo  : bar, bar : foo,  false  :   false,  null  :   null,  integer :  12  }',
                (object) array(
    ...
    /**
     * @group legacy
     * @expectedDeprecation Implicit casting of incompatible mapping keys to strings is deprecated since version 3.3 and will throw \Symfony\Component\Yaml\Exception\ParseException in 4.0.
     * Pass the PARSE_KEYS_AS_STRINGS flag to explicitly enable the type casts.
