...
/* harmony default export */ __webpack_exports__["default"] = ({
	...
	methods: {
		loadMore: function loadMore($state) {
			var that = this;
			console.log('doing');
			__WEBPACK_IMPORTED_MODULE_0_axios___default.a.get('/guess/joins' + '?_token=' + window._Token + '&type=' + that.type + '&api_token=' + window.apiToken + '&page=' + that.page, {
				responseType: 'json'
			}).then(function (ret) {
				$state.loaded();
				var data = ret.data;
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }, [_vm._v("我发起的")]), _vm._v(" "), _c('router-link', {
  ...
  }, [_vm._v("我参与的")])], 1), _vm._v(" "), _c('foot-bar', {
    attrs: {
      "select": "chat"
    }
  }), _vm._v(" "), _c('div', {
    ...
    return _c('div', {
    ...
    }, [_vm._v(" " + _vm._s(item.cash) + " ")]), _vm._v(" "), (item.guess.status == 0) ? _c('span', {
      staticClass: "pay_status"
    }, [_vm._v("\n\t\t\t\t                \t待开台\n\t\t\t\t                ")]) : _vm._e(), _vm._v(" "), (item.guess.status == 1) ? _c('span', {
      staticClass: "pay_status haspay"
    }, [_vm._v("\n\t\t\t\t                \t已开台\n\t\t\t\t                ")]) : _vm._e()])]), _vm._v(" "), _c('div', {
      staticClass: "card-content"
    }, [('mine' == _vm.type) ? _c('div', {
      ...
      staticClass: "avatar",
      attrs: {
        "src": _vm.avatar(item.guess.user.avatar)
      }
    }), _vm._v(" "), _c('div', {
      staticClass: "nickname"
    }, [_vm._v(_vm._s(item.guess.user.nickname || '狗运'))]), _vm._v(" "), _c('div', {
      staticClass: "credit color-red"
    }, [_vm._v("\n\t\t\t\t\t\t\t\t\t\t" + _vm._s(_vm.calcCredit(item.guess.user.not_pay_big_small, item.guess.user.lose_big_small, item.guess.user.not_pay_big_small_cash, item.guess.user.lose_big_small_cash)) + "\n\t\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t")])]), _vm._v(" "), _c('div', {
      staticClass: "col-2"
    }, [_c('div', {
      staticClass: "vs"
    }, [_vm._v("VS")]), _vm._v(" "), (item.guess.status == 0) ? _c('div', {
      staticClass: "result"
    }, [_vm._v("\n\t\t\t\t\t\t\t\t\t\t" + _vm._s(_vm.seeds[item.seed]) + "\n\t\t\t\t\t\t\t\t\t")]) : _c('div', {
      staticClass: "result"
    }, [(item.seed == item.guess.seed) ? _c('span', [_vm._v("胜利")]) : _c('span', [_vm._v("失败")])])]), _vm._v(" "), _c('div', {
      staticClass: "col-4"
    }, [_c('img', {
      staticClass: "avatar",
      attrs: {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-52afa01d", module.exports)
  }
}
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-52afa01d!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./joins.vue", function() {
			var newContent = require("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-52afa01d!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./joins.vue");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
__vue_options__.__file = "/Users/wangfan/Work/webroot/adm/resources/assets/js/pages/guess/joins.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-52afa01d", __vue_options__)
  } else {
    hotAPI.reload("data-v-52afa01d", __vue_options__)
  }
})()}
if (__vue_options__.functional) {console.error("[vue-loader] joins.vue: functional components are not supported and should be defined in plain js files using render functions.")}
