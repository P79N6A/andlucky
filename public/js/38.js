...
/* harmony default export */ __webpack_exports__["default"] = ({
	...
	methods: {
		...
		loadMore: function loadMore($state) {
			var that = this;
			__WEBPACK_IMPORTED_MODULE_1_axios___default.a.get('/invited' + '?_token=' + window._Token + '&api_token=' + window.apiToken + '&page=' + that.page, {
				responseType: 'json'
			}).then(function (ret) {
				$state.loaded();
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    return _c('router-link', {
      ...
      domProps: {
        "innerHTML": _vm._s(_vm.getName(item.nickname))
      }
    })])])])])])])])
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-6a12336a", module.exports)
  }
}
...
__vue_options__.__file = "/Users/wangfan/Work/webroot/adm/resources/assets/js/pages/member/invited.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-6a12336a", __vue_options__)
  } else {
    hotAPI.reload("data-v-6a12336a", __vue_options__)
  }
})()}
if (__vue_options__.functional) {console.error("[vue-loader] invited.vue: functional components are not supported and should be defined in plain js files using render functions.")}
