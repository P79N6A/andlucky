...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_friend_vue__ = __webpack_require__(385);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_menuNav__ = __webpack_require__(255);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_menuNav___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__components_menuNav__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_footNav__ = __webpack_require__(250);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_footNav___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__components_footNav__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_bigsmall__ = __webpack_require__(262);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_bigsmall___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__components_bigsmall__);
...
/* harmony default export */ __webpack_exports__["default"] = ({
	...
	methods: {
		...
		loadMore: function loadMore() {
			var that = this;
			__WEBPACK_IMPORTED_MODULE_5_axios___default.a.get('/im/friends' + '?_token=' + window._Token + '&api_token=' + window.apiToken + '&page=' + that.page, {
				responseType: 'json'
			}).then(function (ret) {
				//$state.loaded();
				if (ret.data.errcode === 0) {
		...
		stolenback: function stolenback(userId) {
			var that = this;
			__WEBPACK_IMPORTED_MODULE_5_axios___default.a.put('/stolen/stolen/' + userId, {
				'_token': window._Token,
				'api_token': window.apiToken
			}, {
				responseType: 'json'
	...
	components: {
		'friend': __WEBPACK_IMPORTED_MODULE_0__components_friend_vue___default.a,
		'menu-nav': __WEBPACK_IMPORTED_MODULE_1__components_menuNav___default.a,
		'foot-bar': __WEBPACK_IMPORTED_MODULE_2__components_footNav___default.a,
		'bigsmall-modal': __WEBPACK_IMPORTED_MODULE_3__components_bigsmall___default.a,
...
__vue_options__.__file = "/Users/wangfan/Work/webroot/adm/resources/assets/js/components/friend.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-44a3fece", __vue_options__)
  } else {
    hotAPI.reload("data-v-44a3fece", __vue_options__)
  }
})()}
if (__vue_options__.functional) {console.error("[vue-loader] friend.vue: functional components are not supported and should be defined in plain js files using render functions.")}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-44a3fece", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "title"
  }, [_vm._v("好友列表")]), _vm._v(" "), _c('router-link', {
    ...
    return _c('div', {
      ...
      attrs: {
        "src": _vm.getAvatar(item.friend.avatar),
        "width": "44"
      }
    })]), _vm._v(" "), _c('router-link', {
      staticClass: "item-inner",
    ...
    }), _vm._v(" "), (item.friend.online == 1) ? _c('span', {
      staticClass: "item-online-status item-online"
    }, [_vm._v("在线")]) : _c('span', {
      ...
      staticClass: "item-title",
      domProps: {
        "innerHTML": _vm._s(item.friend.mobile)
      }
    })])]), _vm._v(" "), _c('div', {
      staticClass: "item-inner ",
      staticStyle: {
      ...
      on: {
        "click": function($event) {
          _vm.showBigSmallModal(item.friend.id)
        }
      }
    }, [_vm._v("比大小")])])])], 1)])])])])
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-46cb11e4", module.exports)
  }
}
...
__vue_options__.__file = "/Users/wangfan/Work/webroot/adm/resources/assets/js/pages/im/friends.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-46cb11e4", __vue_options__)
  } else {
    hotAPI.reload("data-v-46cb11e4", __vue_options__)
  }
})()}
if (__vue_options__.functional) {console.error("[vue-loader] friends.vue: functional components are not supported and should be defined in plain js files using render functions.")}
