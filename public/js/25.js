...
/* harmony default export */ __webpack_exports__["default"] = ({
	...
	created: function created() {
		...
		__WEBPACK_IMPORTED_MODULE_1_axios___default.a.get('/microblog/userinfo' + '?_token=' + window._Token + '&user_id=' + that.$route.params.id + '&api_token=' + window.apiToken).then(function (response) {
	...
	methods: {
		loadMore: function loadMore($state) {
			var that = this;
			__WEBPACK_IMPORTED_MODULE_1_axios___default.a.get('/microblog/list' + '?_token=' + window._Token + '&keyword=' + that.keyword + '&user_id=' + that.$route.params.id + '&api_token=' + window.apiToken + '&page=' + that.page).then(function (response) {
				//console.log( that );
				$state.loaded();
				var data = response.data;
				//如果页码为1 则重置数据
		...
		focus: function focus() {
			var that = this;
			that.user_id = that.$route.params.id;
			__WEBPACK_IMPORTED_MODULE_1_axios___default.a.post('/user/focus', {
		...
		unfocus: function unfocus() {
			var that = this;
			that.user_id = that.$route.params.id;
			__WEBPACK_IMPORTED_MODULE_1_axios___default.a.post('/api/user/unfocus', {
				'_token': window._Token,
				'user_id': that.$route.params.id,
				'api_token': window.apiToken
			}).then(function (response) {
		...
		steal: function steal() {
			...
			var that = this;
			__WEBPACK_IMPORTED_MODULE_1_axios___default.a.put('/stolen/stolen/' + userId, {
				'_token': window._Token,
				'api_token': window.apiToken
			}, {
				responseType: 'json'
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "title"
  }, [_vm._v(_vm._s(_vm.user.nickname) + "的主页")])]), _vm._v(" "), _c('div', {
    staticClass: "content"
  }, [_c('div', {
    staticClass: "user-banner"
  }, [_c('span', {
    staticClass: "avatar img-round"
  }, [_c('img', {
    attrs: {
  ...
  }, [_vm._v("\n\t\t\t\t" + _vm._s(_vm.user.nickname ? _vm.user.nickname : '狗运') + "\n\t\t\t")]), _vm._v(" "), _c('div', {
    staticClass: "user-statics"
  }, [_vm._v("\n\t\t\t\t动态 "), _c('i', [_vm._v(_vm._s(_vm.blog_count))]), _vm._v("    \n\t\t\t\t粉丝 "), _c('i', [_vm._v(_vm._s(_vm.fans_count))]), _vm._v("    \n\t\t\t\t关注 "), _c('i', [_vm._v(_vm._s(_vm.care_count))])]), _vm._v(" "), _c('div', {
    staticClass: "user-focus"
  }, [(!_vm.has_care) ? _c('a', {
    class: {
      active: !!_vm.has_care
    },
    ...
    }, [_c('a', [_vm._v("评论 " + _vm._s(item.comment_count))]), _vm._v(" "), _c('a', {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-3b6b0786", module.exports)
  }
}
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-3b6b0786!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./space.vue", function() {
			var newContent = require("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-3b6b0786!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./space.vue");
...
__vue_options__.__file = "/Users/wangfan/Work/webroot/adm/resources/assets/js/pages/blog/space.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-3b6b0786", __vue_options__)
  } else {
    hotAPI.reload("data-v-3b6b0786", __vue_options__)
  }
})()}
