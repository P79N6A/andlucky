...
/* harmony default export */ __webpack_exports__["default"] = ({
	...
	methods: {
		loadMore: function loadMore($state) {
			var that = this;
			__WEBPACK_IMPORTED_MODULE_0_axios___default.a.get('/stolen/thieves' + '?_token=' + window._Token + '&api_token=' + window.apiToken + '&page=' + that.page, {
				responseType: 'json'
			}).then(function (ret) {
				$state.loaded();
		...
		stolenback: function stolenback(userId) {
			var that = this;
			__WEBPACK_IMPORTED_MODULE_0_axios___default.a.put('/stolen/stolen/' + userId, {
...
// module
exports.push([module.i, "\n.list-block[data-v-2cdf8d0f] {\n\tmargin:0rem;\n}\n.item-inner[data-v-2cdf8d0f]:after {\n\tborder:none;\n\tdisplay: none;\n}\n\n", ""]);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: "page",
    attrs: {
      "id": "stolen-thief-page"
    }
  }, [_c('header', {
    staticClass: "bar bar-nav"
  }, [_c('h1', {
    staticClass: "title"
  }, [_vm._v("谁摸过我")]), _vm._v(" "), _c('router-link', {
  ...
  }, [_vm._l((_vm.thieves), function(item) {
    return _c('li', {
      ...
      on: {
        "click": function($event) {
          _vm.toHome(item.user_id)
        }
      }
    }, [_c('img', {
      attrs: {
        "src": _vm.getAvatar(item.thief.avatar),
        "width": "50"
      }
    })]), _vm._v(" "), _c('div', {
    ...
    }, [_vm._v(_vm._s(item.thief.nickname ? item.thief.nickname : '狗运'))]), _vm._v(" "), _c('span', {
      staticClass: "button button-fill button-danger",
      on: {
        "click": function($event) {
          _vm.stolenback(item.user_id)
        }
      }
    }, [_vm._v("摸回来")])]), _vm._v(" "), _c('div', {
      staticClass: "item-inner"
    }, [_vm._v("\n\t\t              \t最近摸了您" + _vm._s(item.cash) + "点狗粮\n\t\t              ")])])])
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-2cdf8d0f", module.exports)
  }
}
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-2cdf8d0f&scoped=true!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./thief.vue", function() {
			var newContent = require("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-2cdf8d0f&scoped=true!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./thief.vue");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
__vue_options__.__file = "/Users/wangfan/Work/webroot/adm/resources/assets/js/pages/im/thief.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-2cdf8d0f"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-2cdf8d0f", __vue_options__)
  } else {
    hotAPI.reload("data-v-2cdf8d0f", __vue_options__)
  }
})()}
if (__vue_options__.functional) {console.error("[vue-loader] thief.vue: functional components are not supported and should be defined in plain js files using render functions.")}
