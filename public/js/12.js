...
(function (global, factory) {
  ...
  var __vue_inject_styles__$1 = function (inject) {
    if (!inject) return;
    inject("data-v-00c97c04_0", { source: "\n.file-uploads{overflow:hidden;position:relative;text-align:center;display:inline-block\n}\n.file-uploads.file-uploads-html4 input{opacity:0;font-size:20em;z-index:1;top:0;left:0;right:0;bottom:0;position:absolute;width:100%;height:100%\n}\n.file-uploads.file-uploads-html5 input{overflow:hidden;position:fixed;width:1px;height:1px;z-index:-1;opacity:0\n}", map: undefined, media: undefined });
  };
  /* scoped */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_vue_upload_component__ = __webpack_require__(292);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    created: function created() {
        ...
        if (that.$route.params.id) {
            ...
            __WEBPACK_IMPORTED_MODULE_1_axios___default.a.get('/adv/' + that.id + '/edit' + '?api_token=' + window.apiToken, {
                //responseType : 'json'
            ...
            __WEBPACK_IMPORTED_MODULE_1_axios___default.a.get('/advconf' + '?api_token=' + window.apiToken, {
                //responseType : 'json'
            }).then(function (response) {
                console.log(response);
                var data = response.data;
    ...
    methods: {
        ...
        changeCate: function changeCate(g) {
            var that = this;
            that.category_id = g;
            that.category_name = that.cates[g];
            that.showCate = false;
        },
        openPrice: function openPrice() {
            var that = this;
            that.showPrice = true;
            that.showCate = false;
        },
        closePrice: function closePrice() {
            var that = this;
            that.showPrice = false;
        },
        changePrice: function changePrice(g) {
            var that = this;
            that.showPrice = false;
            that.click_price = g;
        }
    ...
    watch: {
        click_times: function click_times(v) {
            console.log(v);
            var that = this;
            v = parseInt(v, 10);
            v = isNaN(v) ? 0 : v;
            var price = parseFloat(that.click_price, 2);
            price = isNaN(price) ? 0 : price;
            that.total_price = (v * price).toFixed(2);
        },
        click_price: function click_price(v) {
            var that = this;
            v = parseFloat(v, 2);
            v = isNaN(v) ? 0 : v;
            var times = that.click_times;
...
// module
exports.push([module.i, "\n.tag[data-v-01693c04] {\n    display: inline-block;\n    padding:.3rem;\n    margin:0.2rem .2rem;\n    border-radius: .2rem;\n    background:#cccccc61;\n}\n.active[data-v-01693c04] {\n    background:#724c41;\n    color:#fff;\n}\n.upload-hander[data-v-01693c04] {\n    width: 100%;\n    height: 8rem;\n    background: url(/images/logo.png) center center no-repeat;\n    background-size: contain;\n    display: block;\n}\n", ""]);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "title"
  }, [_vm._v("编辑广告")])]), _vm._v(" "), _c('foot-bar', {
    attrs: {
      "select": "pub"
    }
  }), _vm._v(" "), _c('div', {
    ...
    staticClass: "item-title label"
  }, [_vm._v("点击价格")]), _vm._v(" "), _c('div', {
    staticClass: "item-input"
  }, [_c('input', {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.click_price),
      expression: "click_price"
    }],
    attrs: {
      "type": "text",
      "readonly": "",
      "placeholder": "请选择单次点击价格"
    },
    domProps: {
      "value": (_vm.click_price)
    },
    on: {
      ...
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.click_price = $event.target.value
      }
    }
  })])])])]), _vm._v(" "), _c('li', [_c('div', {
    staticClass: "item-content"
    ...
    staticClass: "item-title label"
  }, [_vm._v("点击次数")]), _vm._v(" "), _c('div', {
    staticClass: "item-input"
  }, [_c('input', {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.click_times),
      expression: "click_times"
    }],
    attrs: {
      "type": "text",
      "placeholder": "请输入总点击次数"
    },
    domProps: {
      "value": (_vm.click_times)
    },
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.click_times = $event.target.value
      }
    }
  })])])])]), _vm._v(" "), _c('li', [_c('div', {
    staticClass: "item-content"
    ...
    directives: [{
      ...
      rawName: "v-model",
      value: (_vm.last_days),
      expression: "last_days"
    }],
    attrs: {
      "type": "text",
      "placeholder": "最小天数为15天"
    },
    domProps: {
      "value": (_vm.last_days)
    },
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.last_days = $event.target.value
      }
    }
  })])])])]), _vm._v(" "), _c('li', [_c('div', {
    staticClass: "item-content"
    ...
    staticClass: "item-title label"
  }, [_vm._v("总费用")]), _vm._v(" "), _c('div', {
    staticClass: "item-inner color-red"
    ...
    staticClass: "color-gray text-center"
  }, [_vm._v("请上传广告图片，大小不能超过2M")]), _vm._v(" "), _c('p', {
    ...
    staticClass: "button button-big button-fill"
  }, [_vm._v("正在上传广告图")])])])])]), _vm._v(" "), _c('div', {
    staticClass: "modal-overlay ",
    class: {
      'modal-overlay-visible': _vm.showCate
    },
    on: {
      "click": _vm.closeCate
    }
    ...
    staticClass: "modal",
    class: {
      'modal-in': _vm.showCate, 'modal-out': !_vm.showCate
    },
    staticStyle: {
      "display": "block",
      "top": "5rem",
    ...
    return _c('span', {
      staticClass: "tag",
      class: {
        active: index == _vm.category_id
      },
      on: {
        "click": function($event) {
          _vm.changeCate(index)
        }
      }
    }, [_vm._v(_vm._s(item))])
  }))])]), _vm._v(" "), _c('div', {
    staticClass: "modal-overlay ",
    class: {
      'modal-overlay-visible': _vm.showPrice
    },
    on: {
      "click": _vm.closePrice
    }
  }, [_c('div', {
    staticClass: "modal",
    class: {
      'modal-in': _vm.showPrice, 'modal-out': !_vm.showPrice
    },
    staticStyle: {
      "display": "block",
      "top": "5rem",
    ...
    return _c('span', {
      staticClass: "tag",
      class: {
        active: item == _vm.click_price
      },
      on: {
        "click": function($event) {
          _vm.changePrice(item)
        }
      }
    }, [_vm._v(_vm._s(item))])
  })), _vm._v(" "), _c('div', {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-01693c04", module.exports)
  }
}
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-01693c04&scoped=true!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./form.vue", function() {
			var newContent = require("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-01693c04&scoped=true!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./form.vue");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
__vue_options__.__file = "/Users/wangfan/Work/webroot/adm/resources/assets/js/pages/adv/form.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-01693c04"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-01693c04", __vue_options__)
  } else {
    hotAPI.reload("data-v-01693c04", __vue_options__)
  }
})()}
