...
__vue_options__.__file = "/Users/wangfan/Work/webroot/adm/resources/assets/js/pages/member/withdraw.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-0f001fab"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-0f001fab", __vue_options__)
  } else {
    hotAPI.reload("data-v-0f001fab", __vue_options__)
  }
})()}
if (__vue_options__.functional) {console.error("[vue-loader] withdraw.vue: functional components are not supported and should be defined in plain js files using render functions.")}
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        showWithdrawForm: function showWithdrawForm() {
            var that = this;
            that.showModal = 'block';
            __WEBPACK_IMPORTED_MODULE_2_axios___default.a.get('/member/withdrawconf' + '?_token=' + window._Token + '&api_token=' + window.apiToken, {
                responseType: 'json'
            }).then(function (ret) {
        ...
        withdraw: function withdraw() {
            ...
            **/
            __WEBPACK_IMPORTED_MODULE_2_axios___default.a.post('/member/withdraw/apply', {
        ...
        loadMore: function loadMore($state) {
            var that = this;
            __WEBPACK_IMPORTED_MODULE_2_axios___default.a.get('/member/withdraw' + '?_token=' + window._Token + '&type=' + that.type + '&api_token=' + window.apiToken + '&page=' + that.page, {
                responseType: 'json'
            }).then(function (ret) {
                $state.loaded();
                var data = ret.data;
...
// module
exports.push([module.i, "\n.item-media[data-v-0f001fab] {\n    width: 5rem;\n    color:red;\n}\n.item-media em[data-v-0f001fab] {\n    height: 1rem;\n    min-width: 3.8rem;\n    padding: 0 .5rem;\n    font-size: .6rem;\n    line-height: 1rem;\n    color: white;\n    vertical-align: top;\n    border-radius: .5rem;\n    margin-right: .5rem;\n}\n.item-media em.wait[data-v-0f001fab] {\n    background-color: red ;\n}\n.item-media em.success[data-v-0f001fab] {\n    background-color: green;\n}\n.item-media em.reject[data-v-0f001fab] {\n    background-color: gray;\n}\n", ""]);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }, [_c('ul', [_vm._l((_vm.lists), function(item) {
    return _c('li', [_c('div', {
      ...
      staticClass: "wait"
    }, [_vm._v("\n                                    待审核\n                                ")]) : _vm._e(), _vm._v(" "), (item.status == 1) ? _c('em', {
      staticClass: "success"
    }, [_vm._v("\n                                    已完成\n                                ")]) : _vm._e(), _vm._v(" "), (item.status == 2) ? _c('em', {
      staticClass: "reject"
    }, [_vm._v("\n                                    审核失败\n                                ")]) : _vm._e(), _vm._v("\n\n                            " + _vm._s(item.cash))]), _vm._v(" "), _c('div', {
      staticClass: "item-inner"
    }, [_c('div', {
      staticClass: "item-title"
    }, [_vm._v(_vm._s(item.target_desc))]), _vm._v(" "), _c('div', {
    ...
    slot: "no-result"
  }, [_vm._v("没有更多数据了")])])], 2)])])])]), _vm._v(" "), _c('div', {
  ...
  }, [_c('p', [_vm._v("\n                    狗粮汇率为:1\n                ")]), _vm._v(" "), _c('p', [_vm._v("\n                    您当前狗粮为"), _c('em', [_vm._v(_vm._s(_vm.cash))]), _vm._v("点，最大可提现部分为"), _c('em', [_vm._v(_vm._s(_vm.max))]), _vm._v("点\n                ")])]), _vm._v(" "), _c('div', {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-0f001fab", module.exports)
  }
}
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-0f001fab&scoped=true!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./withdraw.vue", function() {
			var newContent = require("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-0f001fab&scoped=true!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./withdraw.vue");
