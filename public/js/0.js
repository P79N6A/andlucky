...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_guess__ = __webpack_require__(282);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_guess___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5__components_guess__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_guessitem__ = __webpack_require__(283);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_guessitem___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6__components_guessitem__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
	...
	methods: {
		loadMore: function loadMore() {
			var that = this;
			__WEBPACK_IMPORTED_MODULE_3_axios___default.a.get('/onlineuser' + '?_token=' + window._Token + '&keyword=' + that.keyword + '&api_token=' + window.apiToken).then(function (response) {
				//console.log( that );
				var data = response.data;
				console.log(data);
		...
		loadGuess: function loadGuess($state) {
			var that = this;
			__WEBPACK_IMPORTED_MODULE_3_axios___default.a.get('/guess/all' + '?_token=' + window._Token + '&keyword=' + that.keyword + '&page=' + that.page + '&api_token=' + window.apiToken).then(function (ret) {
				$state.loaded();
				if (ret.data.errcode === 0) {
					//邀请成功 回到发送信息的页面
	...
	components: {
		...
		'guess-modal': __WEBPACK_IMPORTED_MODULE_5__components_guess___default.a,
		'guess-item': __WEBPACK_IMPORTED_MODULE_6__components_guessitem___default.a,
...
// module
exports.push([module.i, "\n.infinite-scroll-preloader[data-v-477e8dc4] {\n\tmargin-top:-20px;\n}\n.searchbar .searchbar-cancel[data-v-477e8dc4] {\n\tcolor:#fff;\n}\n.index_title[data-v-477e8dc4] {\n\tbackground: url('/images/dog_header.png') no-repeat ;\n\tbackground-size:2.2rem 2.2rem;\n\tpadding-left: 3rem;\n\theight:2.2rem;\n\tdisplay: inline-block;\n\tline-height: 2.2rem;\n\tfont-size: .8em;\n\tcolor:#e8cc40;\n}\n.buttons-tab[data-v-477e8dc4] {\n\tbackground-color: #734d41;\n}\n.buttons-tab .button[data-v-477e8dc4] {\n\theight: 2.2rem;\n\tline-height: 2.2rem;\n\tfont-size: 0.75rem;\n}\n.bar .button[data-v-477e8dc4] {\n\ttop:0rem;\n}\n.buttons-tab .button.active[data-v-477e8dc4] {\n\tborder-color:#fff57e;\n}\na.btn-create[data-v-477e8dc4] {\n\tcolor:#734d41;\n\tfont-size: .65rem;\n}\n", ""]);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }, [_vm._v("押大小")]), _vm._v(" "), _c('a', {
    staticClass: "tab-link button",
    class: {
      active: _vm.type == 'bigsmall'
    },
    on: {
      "click": function($event) {
        _vm.change('bigsmall')
  ...
  }, [_vm._v("手气")])], 1), _vm._v(" "), (_vm.type == 'bigsmall') ? _c('div', {
  ...
  })])])]) : _vm._e(), _vm._v(" "), (_vm.type == 'guess') ? _c('div', {
    staticClass: "bar bar-header-secondary",
    staticStyle: {
      "height": "1.7rem",
      "text-align": "center",
    ...
    staticClass: "pull-right btn-create",
    attrs: {
      "to": {
        name: 'guess-form'
      }
    }
  }, [_vm._v("点我开台")])], 1) : _vm._e(), _vm._v(" "), _c('foot-bar', {
    attrs: {
      "select": "home"
    }
  }), _vm._v(" "), _c('div', {
    staticClass: "content"
  }, [(_vm.type == 'guess') ? _c('guess-item', {
    attrs: {
      "guesses": _vm.guesses
    },
    on: {
  ...
  }, [_vm._v("\n\t\t\t这里是押大小\n\t\t")]) : _vm._e(), _vm._v(" "), (_vm.type == 'bigsmall') ? _c('div', {
    staticClass: "content-block",
    staticStyle: {
      "padding": "0rem",
      "margin-top": "0rem"
    }
  }, [(_vm.users.length > 0) ? _c('user-list', {
    attrs: {
      "users": _vm.users
    },
    on: {
      "userclick": _vm.showBigSmallModal
    }
  }) : _c('div', {
    staticClass: "content-block no-data"
  }, [_vm._v("\n\t        \t暂无在线用户\n\t        ")])], 1) : _vm._e(), _vm._v(" "), (_vm.type == 'guess') ? _c('infinite-loading', {
    ref: "infiniteLoading",
    on: {
    ...
    slot: "no-result"
  }, [_vm._v("没有更多数据了")])]) : _vm._e()], 1), _vm._v(" "), _c('bigsmall-modal', {
    attrs: {
      "to": _vm.to
    },
    on: {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-477e8dc4", module.exports)
  }
}
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-477e8dc4&scoped=true!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./index.vue", function() {
			var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-477e8dc4&scoped=true!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./index.vue");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
__vue_options__.__file = "/Users/wangfan/Work/webroot/adm/resources/assets/js/pages/index.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-477e8dc4"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-477e8dc4", __vue_options__)
  } else {
    hotAPI.reload("data-v-477e8dc4", __vue_options__)
  }
})()}
