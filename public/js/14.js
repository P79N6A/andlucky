...
/* harmony default export */ __webpack_exports__["default"] = ({
	...
	created: function created() {
		console.log('load');
		var that = this;
		__WEBPACK_IMPORTED_MODULE_0_axios___default.a.get('/comment/' + that.$route.params.id + '?api_token=' + window.apiToken).then(function (ret) {
			console.log(ret);
			var data = ret.data;
			if (data.errcode === 0) {
	...
	methods: {
		...
		loadMore: function loadMore($state) {
			var that = this;
			__WEBPACK_IMPORTED_MODULE_0_axios___default.a.get('/comments' + '?_token=' + window._Token + '&id=' + that.$route.params.id + '&type=comment' + '&api_token=' + window.apiToken + '&page=' + that.page).then(function (response) {
				//console.log( that );
				$state.loaded();
		...
		commentSub: function commentSub() {
			var that = this;
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    attrs: {
      "src": _vm.avatar(_vm.comment.user.avatar),
      "width": "45",
      "height": "45"
    }
  })]), _vm._v(" "), _c('div', {
  ...
  }, [_c('a', [_vm._v("评论 " + _vm._s(_vm.comment.comment_count))])])]), _vm._v(" "), _c('div', {
    staticClass: "card",
    staticStyle: {
      "margin": "0px"
    }
  ...
  }, [(_vm.comment.comment_count == 0) ? _c('p', {
    staticClass: "no-data"
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-b3fa8d54", module.exports)
  }
}
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-b3fa8d54!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./comment.vue", function() {
			var newContent = require("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-b3fa8d54!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./comment.vue");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
__vue_options__.__file = "/Users/wangfan/Work/webroot/adm/resources/assets/js/pages/blog/comment.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-b3fa8d54", __vue_options__)
  } else {
    hotAPI.reload("data-v-b3fa8d54", __vue_options__)
  }
})()}
if (__vue_options__.functional) {console.error("[vue-loader] comment.vue: functional components are not supported and should be defined in plain js files using render functions.")}
