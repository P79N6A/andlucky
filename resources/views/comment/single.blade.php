...
<li class="aui-list-item comment-show" data-href="{{route('comment.show' , ['id' => $val->id ])}}">
    <div class="aui-media-list-item-inner">
        ...
        <div class="aui-list-item-inner">
            <div class="aui-list-item-text">
                ...
                @if( data_get( auth()->guard('wap')->user() , 'id' ) == $val->user_id )
                    <div class="aui-list-item-right">
                        <a class="pull-right comment-drop" data-href="{{route('comment.drop' , ['id' => $val->id ])}}" >
